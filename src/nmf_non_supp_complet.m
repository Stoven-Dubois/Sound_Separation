function [W_reel_complet,H_reel_complet, fignbr] = nmf_non_supp_complet(S_reel_complet, T_reel_complet,Dim_reel, fignbr, Nb_iterations, Visualisation_reel_complet_non_supp);
...
%   Detailed explanation goes here
    ...
    if Visualisation_reel_complet_non_supp
        figure(fignbr);
        fignbr = fignbr +1;
    end
    for i=1:Nb_iterations
        [W_reel_complet, H_reel_complet, C_reel_complet] = nmf_non_sup(W_reel_complet, H_reel_complet, S_reel_complet);
